...
public final class FragmentSignUpBinding implements ViewBinding {
  ...
  private FragmentSignUpBinding(@NonNull LinearLayout rootView, @NonNull AppCompatButton btnSignUp,
      @NonNull LottieAnimationView buttonAnimation, @NonNull AppCompatEditText etEmail,
      @NonNull AppCompatEditText etName, @NonNull AppCompatEditText etPassword,
      @NonNull Toolbar toolbarSignUpActivity, @NonNull TextView tvTitle) {
  ...
  public static FragmentSignUpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSignUpBinding((LinearLayout) rootView, btnSignUp, buttonAnimation, etEmail,
          etName, etPassword, toolbarSignUpActivity, tvTitle);
    }
